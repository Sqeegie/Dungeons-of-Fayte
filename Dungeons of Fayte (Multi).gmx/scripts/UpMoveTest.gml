{
    ...
    {
        if(argument0.bbox_top-argument1 < view_yview)
        {
            return 0;
        }
    }
    ...
    if(collisionobj > 0)
    {
        ...
        {
            if(argument0.bbox_top-argument1 < view_yview[0])
            {
                return 0;
            }
            else
        ...
        difference = argument1 - abs(collisionobj.bbox_bottom - argument0.bbox_top);
